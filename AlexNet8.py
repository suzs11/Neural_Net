...
class AlexNet8(Model):
    def __init__(self):
        ...
        self.c1 = Conv2D(filters=48, kernel_size=(7, 7))
        self.b1 = BatchNormalization()
        self.a1 = Activation('relu')
        self.p1 = MaxPool2D(pool_size=(2, 2), strides=2)

        self.c2 = Conv2D(filters=128, kernel_size=(7, 7))
        self.b2 = BatchNormalization()
        self.a2 = Activation('relu')
        self.p2 = MaxPool2D(pool_size=(2, 2), strides=2)

        self.c3 = Conv2D(filters=384, kernel_size=(7, 7), padding='same',
                         activation='relu')
                         
        self.c4 = Conv2D(filters=384, kernel_size=(7, 7), padding='same',
                         activation='relu')
                         
        self.c5 = Conv2D(filters=256, kernel_size=(7, 7), padding='same',
                         activation='relu')
...
plt.legend()
plt.savefig('./images/AlexNet.pdf')
plt.close()
plt.show()
