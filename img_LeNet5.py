...
train_path = './rp_img/train_600/'
train_txt = './rp_img/train_600.txt'
x_train_savepath = './rp_img/x_train.npy'
y_train_savepath = './rp_img/y_train.npy'

test_path = './rp_img/test_200/'
test_txt = './rp_img/test_200.txt'
...
class LeNet5(Model):
    def __init__(self):
        ...
        self.c1 = Conv2D(filters=6, kernel_size=(9, 9),
                         activation='relu')
        self.p1 = MaxPool2D(pool_size=(2, 2), strides=2)

        self.c2 = Conv2D(filters=16, kernel_size=(9, 9),
                         activation='relu')
